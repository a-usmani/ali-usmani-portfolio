            ...
            <div className="flex lg:h-screen   mx-auto " id="about">
                <div className="lg:grid lg:grid-cols-3 lg:gap-4 flex max-lg:flex-col">
                    <div className="lg:col-span-2 max-lg:items-center max-lg:mb-20 flex flex-col  justify-center ">
                        ...
                        <p className="my-8 text-[22px] w-3/4 max-md:mx-auto items-center">I am a developer and designer that has a passion for creating new projects pertaining to full-stack development, object oriented programming, and digital systems. I am always eager to explore any new opportunties that challenge me. Currently, I am a third year studying Computer Engineering (Co-op) at Toronto Metropolitan University as well as over a year of experience working as a maintenance technician at YMCA. I am determined to improve my skills and implement solutions at any given opportunity. </p>
                        <Socials/>
                    </div>
