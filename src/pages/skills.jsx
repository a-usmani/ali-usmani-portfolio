    ...
    const skills = [
        {
            ...
            desc:"Created many websites using React and making use of hooks, API calls, and other tools. These sites have responsive designs and animation by implementing tailwind and GSAP.",
            name:"React",
        },
        {
            ...
            desc:"Efficient in object oriented programming with Java to design complex engineering systems by applying design patterns, testing, error handling, and more.",
            name:"Java",
        },
        {
        ...
        },
        {
            ...
            desc:"MongoDB and firebase to serve as databases for storing user and application data for projects.",
            name:"Databases",
        },
        {
